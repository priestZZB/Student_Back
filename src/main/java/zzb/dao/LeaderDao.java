...
public interface LeaderDao {
     ...
     */
    void insertOneProcessTeacher(@Param("processTeacherAccount") String processTeacherAccount, @Param("password") String password, @Param("processType") String processType, @Param("processTeacherName") String processTeacherName ,@Param("email") String email);
