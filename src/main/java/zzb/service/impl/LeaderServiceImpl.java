package zzb.service.impl;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import zzb.dao.ChargeDao;
import zzb.dao.LeaderDao;
import zzb.dto.Empty;
import zzb.dto.Result;
import zzb.entity.Charge;
import zzb.entity.Problem;
import zzb.entity.ProcessTeacher;
import zzb.service.LeaderService;
...
public class LeaderServiceImpl implements LeaderService {
    ...
    @Override
    @Transactional
    public Result<Empty> addOneProcessTeacher(String processTeacherAccount, String password, String processType, String processTeacherName,String email) {
        try {
            leaderDao.insertOneProcessTeacher(processTeacherAccount, password, processType, processTeacherName, email);
            return new Result<Empty>(empty);
        }catch (Exception e){
            logger.info("增加失败");
            e.printStackTrace();
