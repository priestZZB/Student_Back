...
public interface ChargeService {
     ...
     * @return 结果集
     */
    Result<Empty> addOneCharge(String chargeAccount, String chargePassword, String chargeName,String email);

    /**
     * 修改管理员的密码
     * @param chargeAccount 管理员的账号
     * @param chargePassword 新设置的密码
     * @return 空
     */
    Result<Empty> modifyOneCharge(String chargeAccount, String chargePassword);
